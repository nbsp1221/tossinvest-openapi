...
TypeScript SDK는 npm 패키지로 설치할 수 있습니다.
...
> [!WARNING]
> `clientSecret` / `client_secret`은 서버 사이드 환경에서만 사용하세요. 브라우저, 모바일 앱,
...
SDK는 Toss Securities OpenAPI 1.1.1 문서의 주요 API를 지원합니다.
...
자세한 사용법은 [TypeScript package README](packages/typescript/README.md)와 [Python package README](packages/python/README.md)를 확인하세요.
